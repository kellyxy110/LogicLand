...
import { getParentChildren, type StudentProgress } from "@logicland/database";
import { getCurrentUser } from "@logicland/auth/server";
import { Award, Coins, Star, Trophy } from "lucide-react";
...
export default async function ParentDashboard() {
  ...
  const summaries = await Promise.all(children.map(latestSummary));
